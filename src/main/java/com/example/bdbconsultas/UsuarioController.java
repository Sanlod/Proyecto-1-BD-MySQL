...
public class UsuarioController {
    ...
    public void switchSalud(ActionEvent event) throws IOException {
    ...
    public void switchSinAdoptar(ActionEvent event) throws IOException {
    ...
    public void switchCasaCuna(ActionEvent event) throws IOException {
        cambiarEscena("/com/example/bdbconsultas/CasaCunas.fxml" , event);
    }

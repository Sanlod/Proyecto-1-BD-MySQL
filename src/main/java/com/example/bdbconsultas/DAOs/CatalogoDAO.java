...
public class CatalogoDAO {
    ...
    public static void agregarRaza(String nombre, int idTipo)
            throws SQLException, ClassNotFoundException {
        String sql = "INSERT INTO Breed (id, name, idPetType, createdBy, createdAt, modifiedBy, modifiedAt)" +
                " VALUES (SEQ_BREED.NEXTVAL, ?, ?, USER, CURRENT_TIMESTAMP, USER, CURRENT_TIMESTAMP)";
        try (Connection conn = DBConnection.getConnection();
    ...
    public static void agregarEnfermedad(String nombre, String descripcion)
            throws SQLException, ClassNotFoundException {
        String sql = "INSERT INTO Disease (id, name, description, createdBy, createdAt, modifiedBy, modifiedAt)" +
                " VALUES (SEQ_DISEASE.NEXTVAL, ?, ?, USER, CURRENT_TIMESTAMP, USER, CURRENT_TIMESTAMP)";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
            ps.setString(1, nombre);
    ...
    public static void agregarCanton(String nombre, int idProvincia)
            throws SQLException, ClassNotFoundException {
        String sql = "INSERT INTO Canton (id, name, idProvince, createdBy, createdAt, modifiedBy, modifiedAt)" +
                " VALUES (SEQ_CANTON.NEXTVAL, ?, ?, USER, CURRENT_TIMESTAMP, USER, CURRENT_TIMESTAMP)";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
            ps.setString(1, nombre);
    ...
    public static void agregarDistrito(String nombre, int idCanton)
            throws SQLException, ClassNotFoundException {
        String sql = "INSERT INTO District (id, name, idCanton, createdBy, createdAt, modifiedBy, modifiedAt)" +
                " VALUES (SEQ_DISTRICT.NEXTVAL, ?, ?, USER, CURRENT_TIMESTAMP, USER, CURRENT_TIMESTAMP)";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
            ps.setString(1, nombre);
